...
export function ProviderOperationsWorkspace({ projection }: Props) {
  ...
  return <div className="operations-workspace provider-operations-workspace">
    <header className="operations-masthead operations-masthead--blocked"><div><span><ShieldEllipsis aria-hidden="true" />PROVIDER OPS / READ ONLY</span><h1>Provider Operations</h1><p>这里只投影 policy、plan、receipt、scope、budget 和 gate。凭据存在不等于 ready，本页面不会执行任何 Provider 调用。</p></div><dl><div><dt>模式</dt><dd>{humanLabel(provider.mode)}</dd></div><div><dt>可执行</dt><dd>否</dd></div></dl></header>
